...
Jcrop.registerStageType('Canvas',CanvasStage);
  ...
  $.extend(Selection,{
    ...
    prototype: {
      ...
      toFront: function(){
        this.active = true;
        //test pour changer de box en active element //document.getElementsByClassName(this.element[0].id)[0].style.backgroundColor = "rgb(0, 0,0)";
  ...
  $.extend(Jcrop.prototype,{
    ...
    setSelection: function(sel){
      ...
      gloglo = this
      i = 0;
      while (i < this.ui.multi.length)
      {
        if (this.ui.multi[i].element[0].className == "jcrop-selection jcrop-current")
        {
          var cpt = 0;
          while (document.getElementsByClassName(cpt)[0])
          {
            if (document.getElementsByClassName(cpt).length == 3)
            {
              if (document.getElementsByClassName(cpt)[1].style.backgroundColor == colo1)
              {
                document.getElementsByClassName(cpt)[1].style.backgroundColor = colo2;
                break;
              }
            }
            else
            {
              if (document.getElementsByClassName(cpt)[0].style.backgroundColor == colo1)
              {
                document.getElementsByClassName(cpt)[0].style.backgroundColor = colo2;
                break;
              }
            }
            cpt++;
          }
          if (document.getElementsByClassName(this.ui.multi[i].element[0].id).length == 3)
            document.getElementsByClassName(this.ui.multi[i].element[0].id)[1].style.backgroundColor = colo1;
          else
            document.getElementsByClassName(this.ui.multi[i].element[0].id)[0].style.backgroundColor = colo1;
          break;
        }
        i++;
      }
    ...
    deleteSelection: function(){
      ...
      if (this.ui.selection)
      {
        ...
        while (document.getElementsByClassName(i)[0])
        {
          ...
          {
            if (document.getElementsByClassName(i)[1].style.backgroundColor == colo1)
            {
              if (document.getElementsByClassName("jcrop-selection jcrop-current")[0])
          ...
          else if (document.getElementsByClassName(i).length == 2)
          {
            if (document.getElementsByClassName(i)[0].style.backgroundColor == colo1)
            {
              if (document.getElementsByClassName("jcrop-selection jcrop-current")[0])
                document.getElementsByClassName("jcrop-selection jcrop-current")[0].className = "jcrop-selection";
              document.getElementById(i).className = "jcrop-selection jcrop-current";
