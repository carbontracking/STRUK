...
app.post('/OCR', userController.ensureAuthenticated, ocrController.ocrPost);
app.get('/Upedit', userController.ensureAuthenticated, upeditController.upeditGet);
app.post('/Upedit', userController.ensureAuthenticated, upeditController.upeditPost);
app.post('/upbrowserSave', userController.ensureAuthenticated, HomeController.upbrowserSave);
